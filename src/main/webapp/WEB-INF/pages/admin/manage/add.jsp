...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/admin/manage/add.css" rel="stylesheet">
</head>
<body>
...
<form action="${pageContext.request.contextPath}/store/add" method="post" onsubmit="return test()">
    <table>
        <tr>
            <td><label for="name">店铺名：</label></td>
            <td><input type="text" name="name" id="name" placeholder="请输入店铺名" class="form-control"></td>
            <td><label for="phone">电话：</label></td>
            <td><input type="text" name="phone" id="phone" placeholder="请输入电话" class="form-control"></td>
        </tr>
        <tr>
            <td><label for="address">地址：</label></td>
            <td colspan="3"><input type="text" name="address" id="address" placeholder="请输入地址" class="form-control"></td>
        </tr>
        <tr>
            <td><label for="adminname">管理员姓名：</label></td>
            <td><input type="text" name="adminname" id="adminname" class="form-control"></td>
            <td><label for="adminphone">手机号码：</label></td>
            <td><input type="text" name="adminphone" id="adminphone" class="form-control"></td>
        </tr>
        <tr>
            <td><label for="pwd">密码：</label></td>
            <td><input type="password" name="pwd" id="pwd" class="form-control"></td>
            <td><label for="password0">确认密码：</label></td>
            <td><input type="password" name="password0" id="password0" class="form-control"></td>
        </tr>
    </table>
