...
<div id="result">
    <div>
        <form action="${pageContext.request.contextPath}/sale/storequery" method="post" onsubmit="return test()">
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="name" id="name" value="${qname}" readonly="readonly"
                                           class="form-control"></td>
                </tr>
                <tr>
        ...
        <c:forEach items="${list1}" var="querystore">
            <table id="store" class="table">
                <tr class="success">
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/sale/jumpstoredateview?storeId=${querystore.storeId}">查看柱状图</a>
                    </td>
                </tr>
            </table>
